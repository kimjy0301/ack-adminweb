...
import { deleteAllInterfacePcError } from "../../../modules/api/InterfacePcAPI";
      ...
      if (deptInput === "") {
        interfacePcList.map((value: InterfacePcState) =>
          tempRowDatas.push({
            id: value.id,
            status: value.status,
            equip: value.equip.name,
            dept: value.equip.lab.dept.name,
            lab: value.equip.lab.name,
            emrifpc: value.ip,
